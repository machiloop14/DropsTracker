          ...
          <>
            <View>
              ...
              <Pressable
                ...
                className="flex-row gap-2 items-center border border-[#ebebeb] bg-white py-4  px-3 rounded-xl"
              >
                ...
                {value ? (
                  <Text className="text-[#0b1330] font-spaceRegular">
                    {mode == "date"
                      ? value.toLocaleDateString()
                      : getHoursAndMinutes(value)}
                  </Text>
                ) : (
                  <Text className="text-[#a2a9c6] font-spaceRegular">
